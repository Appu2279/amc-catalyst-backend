...
import { uploadQuestionImage } from '../middleware/uploadMiddleware.js';
import {
  listBatches, getBatch, createBatch, receiveParsed, approveBatch, rollbackBatch, setBatchVisibility, setBatchFree,
  listUnassignedQuestions, addQuestionsToBatch, removeQuestionFromBatch, uploadImage,
...
router.post('/images', uploadQuestionImage, uploadImage);     // must be before /:id
